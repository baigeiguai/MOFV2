...
import torch 
from models.ResTcn_8500_Another import ResTcn
...
class AttentionModule(torch.nn.Module):
    def __init__(self,patch_len=10,seq_len=8500,embed_len=47,n_layers=4,p_dropout=0.25,d_ff=256):
...
class HopeV1_Encoder_Small(torch.nn.Module):    
    def __init__(self):
        super(HopeV1_Encoder_Small,self).__init__()
        self.conv_module = ResTcn(p_dropout=0.15)
        self.att = AttentionModule()
        self.conv_feature_len = 512
        self.att_feature_len = 64
