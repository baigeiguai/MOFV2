...
class AttentionModule(torch.nn.Module):
    def __init__(self,patch_len=10,seq_len=8500,embed_len=15,n_layers=8,p_dropout=0,d_ff=256):
    ...
    def forward(self,raw_intensity,angle):
        ...
        print(patch_feature.shape,embed_feature.shape,intensity_patch_val.shape)
...
class HopeV1(torch.nn.Module):    
    def __init__(self):
        ...
        self.conv_module = ResTcn(p_dropout=0)
