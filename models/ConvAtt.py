...
class CAtBlock(torch.nn.Module):
    def __init__(self,in_c,out_c,L,p_dropout,need_att=True):
...
class ConvAtt(torch.nn.Module):
    def __init__(self,p_dropout=0,L=8500):
        ...
        self.model = torch.nn.Sequential(
            CAtBlock(2,32,L,p_dropout,False),
            CAtBlock(32,32,L//2,p_dropout,False),
            CAtBlock(32,64,L//4,p_dropout,False),
            CAtBlock(64,64,(L+7)//8,p_dropout),
            CAtBlock(64,128,(L+15)//16,p_dropout),
            CAtBlock(128,128,(L+31)//32,p_dropout),
            CAtBlock(128,256,(L+63)//64,p_dropout),
            CAtBlock(256,256,(L+127)//128,p_dropout),
            CAtBlock(256,512,(L+255)//256,p_dropout),
            CAtBlock(512,512,(L+511)//512,p_dropout),
            CAtBlock(512,512,(L+1023)//1024,p_dropout),
            CAtBlock(512,1024,(L+2047)//2048,p_dropout),
            CAtBlock(1024,1024,(L+4095)//4096,p_dropout),
